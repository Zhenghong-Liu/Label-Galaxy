<template>
	<div class="maintenancePlanAdd">
		<div class="child-panel-title">
			<h2 class="title">星系标注</h2>
			<!--<button class="button" @click="RandomSelect">下一张</button>-->
<!--			<img id="hhh" :src="require(`${imageUrl}`)" />-->
		</div>
		<div class="panel-body">
			<div class="demo">
				...
				<div class="draw-btn-group">
					...
					<div @click="saveJson" title="保存json">
...
<script>
	import starlabel_data from '../pagedata/starlabel/starlabel.json'
	export default {
		name: "StarLabel",
		data() {
			return {
		...
		methods: {
			...
			RandomSelect(){
				const randomIndex = Math.floor(Math.random() * this.starlabel_data.length);
				var imgName = this.starlabel_data[randomIndex]
				this.imageUrl = "../pagedata/starlabel/" + imgName
...
//				console.log(eleImportInput.files)
